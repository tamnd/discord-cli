...
Most of these come down to network reality or how discord serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

discord rate-limits like any public site. discord already paces
...
Where a surface is gated, discord reads a cookie or token you supply
...
`discord`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what discord actually did
