...
// HTTP behaviour is covered in discord_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "discord://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("discord", "about")
	if err != nil || got.String() != "discord://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want discord://page/about", got.String(), err)
	}
}
